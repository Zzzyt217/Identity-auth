...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='审计日志表';
...
INSERT INTO `backup_record` VALUES (11,'FULL',NULL,NULL,'2026-04-01 14:50:26','FAILED',0,'\'D:/MySQL/MySQL\' �����ڲ����ⲿ���Ҳ���ǿ����еĳ���\r\n���������ļ���\r\n\'allowPublicKeyRetrieval\' �����ڲ����ⲿ���Ҳ���ǿ����еĳ���\r\n���������ļ���\r\n\'characterEncoding\' �����ڲ����ⲿ���Ҳ���ǿ����еĳ���\r\n���������ļ���','SYSTEM',NULL),(12,'FULL',NULL,NULL,'2026-04-01 14:53:27','FAILED',0,'\'D:/MySQL/MySQL\' �����ڲ����ⲿ���Ҳ���ǿ����еĳ���\r\n���������ļ���','SYSTEM',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='DID身份表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-01 14:58:03
